                    ...
                    <table class="table table-striped table-hover" id="datatable-example">
                        ...
                        <tbody>
                            ...
                            foreach ($objList as $obj) {
                                ...
                                <tr class="gradeA">
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $obj->organization_name; ?></td>
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">												
                                                <li>
                                                    <a data-target="#edit" role="button" data-toggle="modal" title="Edit Data"
                                                       id="edit_<?php echo $obj->organization_id; ?>"
                                                       name="edit_<?php echo $obj->organization_id; ?>" href="">
                                                        Edit Data</a>
                                                </li>
                                                <li>
                                                    <a data-target="#delete" role="button" data-toggle="modal" title="Delete Data"
                                                       onclick="$('input[name=deleted_id]').val(<?php echo $obj->organization_id; ?>)"
                                                       href="">
                                                        Delete Data</a>
                                                </li>
                                            </ul>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form role="form" action="<?php echo base_url('backend/organization/add') ?>" method="post" id="form_add">
            <div class="modal-content">
                ...
                <div class="modal-body">																			
                    <div class="form-group">
                        ...
                        <input type="text" id="organization_name" name="organization_name" class="form-control has-feedback" autofocus />
                    </div>
                </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form role="form" action="<?php echo base_url('backend/organization/edit'); ?>" method="post" id="form_edit">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">                                
                    <div class="form-group">
                        <label>Organization name</label>
                        <input type="text" id="edit_organization_name" name="edit_organization_name" class="form-control has-feedback" autofocus />
                        <input type="hidden" name="edit_organization_id" value="">
                    </div>                    
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form role="form" action="<?php echo base_url('backend/organization/delete'); ?>" method="post" id="form_delete">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
